...
@section('content')
  <div class="max-w-xs mt-5">
    ...
    <x-ToDoAlert />
    <form method="post" action="{{ route('todo.update', $todo->id) }}"  class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      @csrf
      @method('patch')
      <div class="mb-6">
        ...
        <input type="text" value="{{ $todo->title }}" id="title" name="title"   placeholder="Título del ToDo" 
